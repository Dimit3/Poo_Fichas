...
public class EncEficiente {
    ...
    //by parameters
    public EncEficiente(String nome, int nif, String morada, int numeroDaEncomenda, LocalDate data, ArrayList<Linhadeencomenda> linhas) {
        this.nome = nome;
        this.nif = nif;
        this.morada = morada;
     ...
     * 
     */
    public EncEficiente(String nome, int nif, String morada, int numeroDaEncomenda, LocalDate data) {
        this.nome = nome;
        this.nif = nif;
        this.morada = morada;
        this.numeroDaEncomenda = numeroDaEncomenda;
    ...
    public void setNumeroDaEncomenda(int numeroDaEncomenda) {
        this.numeroDaEncomenda = numeroDaEncomenda;
    }
